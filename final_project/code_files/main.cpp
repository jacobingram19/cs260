...
I test the shortest_path() function from the Graph class on "alphabet_graph".
I test the min_spanning_tree() function from the Graph class on "alphabet_graph_2".
I test the shortest_path() and min_spanning_tree() function from the Graph class on "vvardenfell_graph".
